...
> 目的：量化 persona 注入和反AI规则各自贡献了多少改进。

## 实验设计

| 组别 | 配置 | 控制变量 |
|------|------|----------|
| A 组（baseline） | 无 persona，无反AI规则 | "你是网文写作专家" + 纯章纲 |
| B 组（persona-only） | 有 persona，无反AI规则 | persona 定义 + 语感样本 + 章纲 |
| C 组（rules-only） | 无 persona，有反AI规则 | "你是网文写作专家" + 章纲 + 反AI补丁 |
| D 组（full） | 有 persona，有反AI规则 | 当前完整 prompt |
...
- A vs B：persona 贡献多少？
- A vs C：反AI规则贡献多少？
- B vs D：反AI规则在 persona 基础上额外贡献多少？
