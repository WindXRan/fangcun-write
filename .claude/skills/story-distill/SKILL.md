...
**产出**：每本书写入 `.distill/book-overviews/{书名}.md` + `.distill/writing-samples-{书名}.md`
...
读取数据：
- 读取 {输出目录}/.distill/sources/{书名}.txt
...
输出要求：
- 写入 {输出目录}/.distill/book-overviews/{书名}.md
...
| 文件 | 内容 |
|------|------|
| `.distill/book-overviews/{书名}.md` | 每本书的结构分析（含章名风格+章节密度+分层精读计划） |
| `.distill/writing-samples-{书名}.md` | 每本书的 5 类语感样本，每段附出处 |

### 1.6 汇总

所有 agent 完成后，主线程：
1. 汇总各书的 `.distill/book-overviews/` 和 `.distill/writing-samples-*.md`
...
**并行** spawn 15 个 Task sub-agents：

| subagent | 读取的 prompt | 读取的数据 | 产出文件 |
|----------|--------------|-----------|---------|
| 1 心智模型+人设架构 | `extractors/mental-model-extractor.md` | `.distill/book-overviews/*.md` + `.distill/sources/*.txt` | `.distill/candidates/mental-models.md` |
| 2 决策启发式 | `extractors/decision-heuristic-extractor.md` | `.distill/book-overviews/*.md` + `.distill/sources/*.txt` | `.distill/candidates/decision-heuristics.md` |
| 3 节奏直觉+节奏曲线 | `extractors/rhythm-intuition-extractor.md` | `.distill/book-overviews/*.md` + `.distill/sources/*.txt` | `.distill/candidates/rhythm-intuition.md` |
| 4 表达DNA | `extractors/expression-dna-extractor.md` | `.distill/book-overviews/*.md` + `.distill/sources/*.txt` | `.distill/candidates/expression-dna.md` |
| 5 反模式 | `extractors/anti-pattern-extractor.md` | `.distill/book-overviews/*.md` + `.distill/sources/*.txt` | `.distill/candidates/anti-patterns.md` |
| 6 书名简介 | `extractors/synopsis-extractor.md` | 每本书的书名+简介+标签 | `.distill/candidates/synopsis-patterns.md` |
| 7 章纲模板+钩子分析 | `extractors/chapter-parser.md` | `.distill/sources/*.txt` | `.distill/candidates/chapter-template.md` |
| 8 去AI策略 | `extractors/de-ai-extractor.md` | `.distill/sources/*.txt` + `de-ai-modules/*.md` | `.distill/candidates/de-ai-strategy.md` |
| 9 爽点分布 | `extractors/satisfaction-point-extractor.md` | `.distill/book-overviews/*.md` + `.distill/sources/*.txt` | `.distill/candidates/satisfaction-points.md` |
| 10 评分模型 | `extractors/scoring-model-extractor.md` | `.distill/book-overviews/*.md` + `.distill/candidates/*.md` + `.distill/sources/*.txt` | `.distill/candidates/scoring-model.md` |
| **11 审稿红线** | `extractors/review-redline-extractor.md` | `.distill/book-overviews/*.md` + `.distill/sources/*.txt` + `.distill/candidates/anti-patterns.md` | `.distill/candidates/review-redlines.md` |
| **12 修改处方** | `extractors/edit-prescription-extractor.md` | `.distill/book-overviews/*.md` + `.distill/sources/*.txt` + `.distill/candidates/*.md` | `.distill/candidates/edit-prescriptions.md` |
| **13 质量阈值** | `extractors/quality-threshold-extractor.md` | `.distill/sources/*.txt` + `.distill/book-overviews/*.md` + `.distill/writing-samples-*.md` | `.distill/candidates/quality-thresholds.md` |
| **14 审稿人格** | `extractors/review-persona-extractor.md` | `.distill/book-overviews/*.md` + `.distill/sources/*.txt` + `.distill/candidates/*.md` | `.distill/candidates/review-persona.md` |
| **15 修改能力** | `extractors/revision-capability-extractor.md` | `.distill/book-overviews/*.md` + `.distill/sources/*.txt` + `.distill/candidates/*.md` + `.distill/candidates/review-persona.md` | `.distill/candidates/revision-capability.md` |
...
- 读取 {输出目录}/.distill/sources/*.txt（原文，重点读精读章节）
...
|----------|---------|---------|------|
| 1 跨书验证 | 同一决策规则在 ≥2 本书中出现 | `.distill/candidates/*.md` | 标记「可能偶然」的规则 |
| 2 频率验证 | 出现频率 ≥5%（非偶发） | `.distill/candidates/*.md` | 低频规则写入 `rejected/` |
| 3 独特性验证 | 满足任一锚点即通过 | `.distill/candidates/*.md` + 对比基准 | 通用规则写入 `rejected/` |
...
# 写模式上限 14，审稿模式上限 19（多 review/ 2 + 5 review 专用 references）
...
└── references/                       # 16 个
    ...
    └── revision-capability.md        # 修改能力
```

= 21 个文件（write 14 + review/ 2 + 5 review 专用 references）
