...
1. **故事核**：一句话概括（谁+什么处境+怎么解决+结局）
2. **三幕结构**：
   - 第一幕（1-25%）：建立世界观+核心冲突+破冰事件
   - 第二幕（25-75%）：冲突升级+多次转折+高潮
   - 第三幕（75-100%）：危机+决战+结局
3. **关键转折点**：至少 5 个（含情绪曲线标记）
4. **爽点分布**：每 5-10 章一个小爽点，每 20-30 章一个大爽点
5. **伏笔清单**：主线伏笔 3-5 个，每 30 章回收一个
