---
version: 6
changelog: 增加口头禅、邻里生态设计（第三空间+互动模式+社区记忆点）
type: user
...
- 性格内核：{2-3句话描述性格本质}
- 核心动机：{他/她最想要什么}
- 口头禅/标志性台词：{1-2句这个人会反复说的话，要有辨识度}
- 关系：{与主角/其他角色的关系}
```

**主要角色**填写完整。**配角**至少填写功能位+性格内核+口头禅。

### 邻里生态设计

在角色卡之后，补充一个"社区生态"段落：

1. **第三空间**：设计1-2个非家庭非学校的公共场景（如小区棋牌室、楼下小卖部、菜市场），这些场景是配角互动的舞台
2. **互动模式**：设计2-3组固定的配角互动关系（如麻将搭子、遛狗搭子、买菜搭子），让配角之间有独立于主角的关系网
3. **社区记忆点**：设计2-3个能体现社区感的细节（如小区微信群的昵称、谁家做了好吃的会端给谁、谁和谁吵架了全小区都知道）

邻里生态的功能：提供笑点、传递信息、制造巧合、让世界有"烟火气"。
</output>
