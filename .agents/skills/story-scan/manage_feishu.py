...
示例：
  python manage_feishu.py backup   # 备份配置
  python manage_feishu.py restore  # 恢复配置
  python manage_feishu.py list     # 列出备份
  python manage_feishu.py export   # 导出配置
  python manage_feishu.py import   # 导入配置
  python manage_feishu.py reset    # 重置配置
""")
