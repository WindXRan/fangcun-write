...
使用方法：
  python diagnose_config_feishu.py [选项]
...
示例：
  python diagnose_config_feishu.py env         # 诊断环境变量
  python diagnose_config_feishu.py connection  # 诊断飞书连接
  python diagnose_config_feishu.py all         # 诊断所有配置
""")
