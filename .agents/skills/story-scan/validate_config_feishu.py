...
使用方法：
  python validate_config_feishu.py [选项]
...
示例：
  python validate_config_feishu.py env         # 验证环境变量
  python validate_config_feishu.py connection  # 验证飞书连接
  python validate_config_feishu.py all         # 验证所有配置
""")
