...
| 查故事资料 | 查角色、查伏笔、查进度、查设定、什么状态、写到哪了 | spawn `story-explorer` agent |
| 查资料 | 查资料、帮我查资料、调研、搜索一下、搜一下 | spawn `story-researcher` agent |
...
- **无项目目录**：如果用户要写作，下一步是先运行 `/story-setup` 初始化环境
