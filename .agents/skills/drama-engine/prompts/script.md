...
- **时间**：日/夜/黄昏/雨夜/晨
- **内外景**：内/外
- **小场景名**：具体到发生剧情的位置（如"别墅里的不同房间"要分开标注）
- **人物**：同场景下所有出现的人都要标注，离开的人要写明离开，下一幕去掉
- **一集内场景切换不超过 3 幕**
...
示例：
```
△沈灵珊拿起翻盖手机，登录QQ，给林然发信息。【内容：睡了没？】
△信息发过去，手机响起滴滴声。
沈灵珊：（高兴）秒回我！我就知道你心里还有我！
△沈灵珊定睛一看，发现对方已不是自己的好友。
△沈灵珊愣住。
```
...
对白必须像真人说话，不允许：
- 解释性独白（"我看到的不是现在，是下一次进化路线" → 改为"莫非，我看到的是下一次进化路线！"）
- 书面语（"我决定要用我自己的方式" → 改为口语化表达）
- 平淡无情绪的陈述（必须有情绪波动：震惊/愤怒/疑惑/兴奋）

好的对白：`为什么明明有了金手指，而我还是这么倒霉？？`
坏的对白：`我看到的不是现在。是下一次进化路线。`（太平淡，不像人话）

### 信息传达规则（硬性）

**所有信息必须通过人物语言展现**，不能只靠画面：
- 可以是主动说出
- 可以是内心独白（OS）
- 可以是周围人谈论
- 不能只用△画面描述传递关键信息

**信息+画面配对**：每句传递重要信息的台词，前面必须有对应的△画面描写。不能只说不画：
```
坏：何森：人类能活到今天，靠的是异兽基因。（只有台词，没有画面）
好：△何森转身指向电子黑板，屏幕上闪过人类与异兽搏斗的历史画面。
   何森：人类能活到今天，靠的是异兽基因。（信息+画面配对）
```

**台词不能说废话**：观众已经知道的事、不推动剧情的话、没有情绪价值的陈述，全部删掉：
```
坏：何森：三天后，拿不到名额的人，别想进化。（废话，名额本来就是竞争的）
好：△何森敲了敲黑板，全班安静下来。
   何森：今年，五班只有六个名额。（直接给信息，不废话）
```

**对话前必须有动作**：每句台词前面必须有△描写人物说话时的动作/表情/状态：
```
坏：王青：别问，心脏疼。（直接台词，没有动作）
好：△王青捂着胸口，脸色发白。
   王青：别问，心脏疼。（动作+台词）
```
...
示例：
```
△何森头顶浮现：【蓝尾霜鹰，三次进化，契合度73%】。
王青OS：何老师不是才二次进化吗？而且他觉醒的也不是"蓝尾霜鹰"
```
（信息通过OS传达，不只是画面）
