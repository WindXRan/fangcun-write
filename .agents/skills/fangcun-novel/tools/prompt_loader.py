...
EMBED_TAGS = {"源文", "弧线", "弧线参考", "设定", "新书设定", "plot_guide", "模板", "旧真相", "本章正文", "下章正文", "原文", "热梗素材", "频道配置", "题材配置", "爽点配置", "style", "characters", "structure", "principles", "world", "highlights", "blacklist", "event", "name_map"}
